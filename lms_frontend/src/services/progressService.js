 ...
 * In Supabase mode, computes values from user_course_progress, enrollments, profiles, courses.
 */
  ...
  async getAdminSummary() {
    ...
    if (isSupabaseMode()) {
      ...
      return {
        ...
        activeUsers: null, // requires activity tracking; can be derived via recent progress if available
